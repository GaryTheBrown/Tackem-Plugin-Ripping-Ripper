...
CONFIG = ConfigList(
    ...
    ConfigList(
        ...
        ConfigObjString(
            ...
            "Where do you want to store videos while ripping them?"
        ),
        ConfigObjString(
            "videoripped",
            "videoripped/",
            "Video Ripped Location",
            "Where do you want to move the videos when ripped?"
        ),
        ConfigObjString(
            "audioripping",
            "audioripping/",
            "Video Ripping Location",
            "Where do you want to store audios while ripping them?"
        ),
        ConfigObjString(
            "audioripped",
            "audioripped/",
            "Video Ripped Location",
            "Where do you want to move audio files when ripped?"
        ),
    ),
    ConfigList(
        "videoripping",
...
Use the slowest preset that you have patience for."""
        ...
        ConfigObjOptionsSelect(
            "originalordub",
            [
                ConfigObjOption("original", "Original"),
                ConfigObjOption("dub", "Dubbed")
            ],
            "original",
            "Original or Dubbed as Defaut Language",
            """
...
"""
        ...
        ConfigObjBoolean(
            ...
            True,
            "Keep Chapters",
            "Do you want to keep the chapters points?"
        ),
        ...
        ConfigObjBoolean(
            ...
            help_text="Do you want to keep the closed captions?"
        )
    ),
    ConfigList(
        "drives",
